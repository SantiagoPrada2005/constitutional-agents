...
-- Dominio Administrativo (Ley 1437 de 2011 - CPACA)
(12, NULL, 'administrativo', 6, 'vec-admin-peticion', '02_administrativo/cpaca_ley_1437.md', 'Derecho de Petición y Términos de Respuesta (Arts. 13-33 CPACA)', 'Toda persona tiene derecho a presentar peticiones respetuosas a las autoridades. Términos legales de respuesta: 15 días hábiles para peticiones de interés general o particular; 10 días hábiles para solicitudes de información y copias; 30 días hábiles para consultas jurídicas. El silencio administrativo negativo opera a los 3 meses sin respuesta.'),
(13, NULL, 'administrativo', 6, 'vec-admin-recursos', '02_administrativo/cpaca_ley_1437.md', 'Vía Gubernativa y Recursos Ordinarios (Arts. 74-82 CPACA)', 'Contra los actos administrativos definitivos proceden el Recurso de Reposición (ante el mismo funcionario, facultativo) y el Recurso de Apelación (ante el superior jerárquico, obligatorio para agotar vía administrativa). Deben interponerse por escrito dentro de los 10 días hábiles siguientes a la notificación.'),
(14, NULL, 'administrativo', 6, 'vec-admin-medios-control', '02_administrativo/cpaca_ley_1437.md', 'Medios de Control: Nulidad y Restablecimiento y Reparación Directa', 'Nulidad y Restablecimiento del Derecho (Art. 138 CPACA): amparo de derechos subjetivos con término de caducidad perentorio de 4 meses. Reparación Directa (Art. 140 CPACA): responsabilidad extracontractual por daño antijurídico del Estado con caducidad de 2 años.'),
-- Dominio Penal (Ley 906 de 2004 - Sistema Acusatorio)
(15, NULL, 'penal', 7, 'vec-penal-principios', '03_penal/codigo_procesal_penal_ley_906.md', 'Principios Rectores del Sistema Penal Acusatorio (Arts. 1-27 CPP)', 'Dignidad humana, libertad personal, presunción de inocencia e in dubio pro reo. Toda persona se presume inocente hasta que se declare su culpabilidad en sentencia judicial ejecutoriada. El derecho a la defensa técnica es irrenunciable desde el momento de la captura o vinculación.'),
(16, NULL, 'penal', 7, 'vec-penal-captura', '03_penal/codigo_procesal_penal_ley_906.md', 'Régimen de Captura y Plazo de 36 Horas ante Juez de Garantías', 'La captura procede por orden judicial previa o en flagrancia. La persona capturada debe ser puesta a disposición del Juez de Control de Garantías en un término improrrogable de 36 horas para el control de legalidad de la aprehensión (Art. 302 CPP).'),
(17, NULL, 'penal', 7, 'vec-penal-aseguramiento', '03_penal/codigo_procesal_penal_ley_906.md', 'Medidas de Aseguramiento Cautelares y Fines Constitucionales', 'El juez puede imponer medida de aseguramiento privativa (cárcel o domiciliaria) o no privativa únicamente si resulta necesaria para evitar la obstrucción de la justicia, proteger a la comunidad o víctimas, o asegurar la comparecencia del imputado (Art. 308 CPP).'),
-- Dominio Laboral (CST y Ley 100 de 1993)
(18, NULL, 'laboral', 8, 'vec-lab-elementos', '04_laboral/codigo_sustantivo_trabajo_cst.md', 'Elementos Esenciales del Contrato de Trabajo y Presunción (Arts. 23-24 CST)', 'Se configura contrato de trabajo con: 1) Actividad personal, 2) Continuada subordinación o dependencia, y 3) Salario remuneratorio. El Art. 24 CST consagra la presunción de que toda relación de trabajo personal está regida por contrato de trabajo.'),
(19, NULL, 'laboral', 8, 'vec-lab-despido', '04_laboral/codigo_sustantivo_trabajo_cst.md', 'Despido Injustificado e Indemnizaciones Tarifadas (Art. 64 CST)', 'En contratos a término fijo se indemniza el valor de los salarios correspondientes al tiempo faltante. En contratos a término indefinido (para salarios menores a 10 SMLMV) se pagan 30 días de salario por el primer año y 20 días por cada año adicional.'),
(20, NULL, 'laboral', 8, 'vec-lab-estabilidad', '04_laboral/codigo_sustantivo_trabajo_cst.md', 'Estabilidad Laboral Reforzada: Fuero de Maternidad y Salud', 'Prohibición de despido discriminatorio: fuero de maternidad (Art. 239 CST, reintegro obligatorio) y fuero de salud (Ley 361 de 1997, Art. 26). El despido de un trabajador en debilidad manifiesta sin autorización del Ministerio del Trabajo es ineficaz y genera indemnización sancionatoria de 180 días de salario.'),
-- Dominio Civil y Comercial (Ley 1564 de 2012 - CGP)
(21, NULL, 'civil', 9, 'vec-civ-competencia', '05_civil_comercial/codigo_general_proceso_cgp.md', 'Factores de Competencia Judicial: Cuantía y Territorio (Arts. 15-34 CGP)', 'Competencia por cuantía: Mínima cuantía hasta 40 SMLMV; Menor cuantía entre 40 y 150 SMLMV; Mayor cuantía superior a 150 SMLMV. Competencia territorial: regla general domicilio del demandado (forum domicilii); en inmuebles lugar de ubicación (forum rei sitae).'),
(22, NULL, 'civil', 9, 'vec-civ-pruebas', '05_civil_comercial/codigo_general_proceso_cgp.md', 'Régimen Probatorio y Carga Dinámica de la Prueba (Arts. 164-167 CGP)', 'Las decisiones deben basarse en pruebas válidamente aportadas. Incumbe a las partes probar los supuestos de hecho, pero el juez puede distribuir la carga probatoria exigiendo acreditar a la parte en mejor condición técnica o material.'),
(23, NULL, 'civil', 9, 'vec-civ-ejecutivo', '05_civil_comercial/codigo_general_proceso_cgp.md', 'Proceso Ejecutivo y Título Ejecutivo (Art. 422 CGP)', 'Procede la ejecución coactiva sobre obligaciones expresas, claras y actualmente exigibles que consten en documentos provenientes del deudor o de sentencia judicial. El mandamiento de pago otorga 5 días para pagar y 10 días para formular excepciones de mérito.');
